...
(function(M, Y, t) {
	...
	function S(b) {
		return function() {
			var a = arguments[0],
				c;
			c = "[" + (b ? b + ":" : "") + a + "] http://errors.angularjs.org/1.3.12/" + (b ? b + "/" : "") + a;
	...
	function qc(b) {
		...
		s((b || "").split("&"), function(b) {
			b && (c = b.replace(/\+/g, "%20").split("="), d = pc(c[0]), y(d) && (b = y(c[1]) ? pc(c[1]) : !0, rc.call(a, d) ? H(a[d]) ? a[d].push(b) : a[d] = [a[d], b] : a[d] = b))
		});
		return a
	}
	...
	function Nd() {
		var b;
		uc || ((sa = M.jQuery) && sa.fn.on ? (D = sa, x(sa.fn, {
			scope: La.scope,
	...
	function yb(b, a) {
		var c = b.ng339,
			d = c && Ab[c];
		d && (a ? delete d.data[a] : (d.handle && (d.events.$destroy && d.handle({}, "$destroy"), Hc(b)), delete Ab[c], b.ng339 = t))
	}
	...
	function wc(b, a) {
		...
		this.directive = function n(a, e) {
			Ma(a, "directive");
			F(a) ? (Rb(e, "directiveFactory"), d.hasOwnProperty(a) || (d[a] = [], b.factory(a + "Directive", ["$injector", "$exceptionHandler",
				function(b, e) {
					var f = [];
					s(d[a], function(d, g) {
						try {
			...
			function(a, b, c, r, P, p, v, w, L, C, A) {
				...
				function E(a, b, c, d, e) {
					...
					return function(b, c,
						...
						d = "html" !== g ? D(Wb(g, D("<div>").append(a).html())) : c ? La.clone.call(a) : a;
						if (h)
					...
					switch (a.nodeType) {
						case oa:
							...
							for (var k, q, n, r = a.attributes, p = 0, w = r && r.length; p <
								...
								q = U(k.value);
								k = ya(l);
								if (n = gb.test(k)) l = l.replace(Rc, "").substr(8).replace(/_(.)/g, function(a, b) {
				...
				function fa(a,
					...
					function v(a, c, f, g, h) {
						...
						d === f ? (J = e, W = e.$$element) : (W = D(f), J = new Xb(W, e));
						T && (A = c.$new(!0));
					...
					for (var A = -Number.MAX_VALUE, O, C = r.controllerDirectives, X, T = r.newIsolateScopeDirective, ka = r.templateDirective, fa = r.nonTlbTranscludeDirective, da = !1, B = !1, z = r.hasElementTranscludeDirective, aa = e.$$element = D(d), K, x, N, Aa = f,
						...
						})) : (N = D(Ub(d)).contents(), aa.empty(), Aa = E(N, f));
						if (K.template)
							if (B = !0, Oa("template", ka, K, aa), ka = K, N = G(K.template) ? K.template(aa, e) : K.template, N = Sc(N), K.replace) {
								l = K;
								N = Sb.test(N) ? Tc(Wb(K.templateNamespace, U(N))) : [];
								d = N[0];
				...
				function da(b, e, f, g, h, l, k) {
					...
					if (d.hasOwnProperty(e)) {
						...
						for (var r = 0, p = e.length; r < p; r++) try {
							q = e[r], (g === t || g > q.priority) && -1 != q.restrict.indexOf(f) && (l && (q = Ob(q, {
								$$start: l,
								$$end: k
							})), b.push(q), h = q)
						} catch (w) {
					...
					r(L.getTrustedResourceUrl(P)).then(function(r) {
						...
						for (q = T(b[0].childNodes, e); l.length;) {
							...
							if (!r.$$destroyed) {
								if (v !== n) {
									var J = v.className;
									h.hasElementTranscludeDirective && p.replace || (A = Ub(L));
									V(C, D(v), A);
									O(D(A), J)
								}
				...
				function V(a, b, c) {
					...
					a.appendChild(d);
					D(c).data(D(d).data());
					sa ? (Qb = !0, sa.cleanData([d])) : delete D.cache[d[D.expando]];
					d = 1;
	...
	function Yb(b, a) {
		if (F(b)) {
			...
			if (c) {
				...
				(d = d && 0 === d.indexOf(Vc)) || (d = (d = c.match(sf)) && tf[d[0]].test(c));
				d && (b = oc(c))
			}
		}
		return b
			...
			function(d, e, f, g, h, l) {
				...
				function m(c, f) {
					function l(b, c, d, e) {
						...
						O && (200 <= b && 300 > b ? O.put(X, [b, c, Wc(d), e]) : O.remove(X));
					...
					B(E) && ((E = Zc(c.url) ? e.cookies()[c.xsrfCookieName || b.xsrfCookieName] : t) && (s[c.xsrfHeaderName || b.xsrfHeaderName] = E), d(c.method, X, f, l, s, c.timeout, c.withCredentials, c.responseType));
					return A
				}
		...
		this.$get = ["$rootScope", "$browser", "$sniffer", "$rootElement", "$window",
			function(c, d, e, f, g) {
				...
				var n = d.url(),
					q;
				if (a.enabled) {
					if (!m && a.requireBase) throw Gb("nobase");
				...
				c.$watch(function() {
					var a = bd(d.url()),
						...
						g = k.$$replace,
						q =
							a !== b || k.$$html5 && e.history && f !== k.$$state;
				...
				return function(d, f, g) {
					...
					switch (typeof d) {
						case "string":
							...
							var C = g ? a : b;
							v = C[L];
							v || (":" === d.charAt(0) && ":" === d.charAt(1) && (w = !0, d = d.substring(2)), g = g ? u : q, v = new gc(g), v = (new ib(v, c, g)).parse(d), v.constant ? v.$$watchDelegate = m : w ? (v = e(v), v.$$watchDelegate = v.literal ? k : l) : v.inputs && (v.$$watchDelegate = h), C[L] = v);
							return n(v, f);
						case "function":
							return n(d, f);
						default:
	...
	function rd(b, a, c, d, e) {
		...
		f.$setPristine = function() {
			d.setClass(b, Sa, Lb + " ng-submitted");
			f.$dirty = !1;
			f.$pristine = !0;
			f.$submitted = !1;
			s(g, function(a) {
	...
	s({
		...
		R.prototype[a] = function(a, d) {
			...
			if (b !== Jc && (2 == b.length && b !== Bb && b !== Ic ? a : d) === t) {
				if (I(a)) {
					for (e = 0; e < g; e++)
						if (b === Vb) b(this[e], a);
						else
	...
	s({
		...
		R.prototype[c] = function(c, e, f) {
			for (var g, h = 0, l = this.length; h < l; h++) B(g) ? (g = a(this[h], c, e, f), y(g) && (g = D(g))) : Gc(g, a(this[h], c, e, f));
			return y(g) ? g : this
		};
	...
	s([cd, dc, cc], function(a) {
		...
		a.prototype.state = function(c) {
			...
			if (a !== cc || !this.$$html5) throw Gb("nostate");
	...
	gc.prototype = {
		...
		lex: function(a) {
			...
			if (this.isNumber(a) || "." === a && this.isNumber(this.peek())) this.readNumber();
		...
		dg = ["$scope", "$exceptionHandler", "$attrs", "$element", "$parse", "$animate", "$timeout", "$rootScope", "$q", "$interpolate",
			function(a, c, d, e, f, g, h, l, k, m) {
				...
				this.$$setOptions = function(a) {
					...
					} else if (!n.assign) throw Nb("nonassign", d.ngModel, va(e));
				};
				this.$render = z;
				...
				this.$$runValidators = function(a, c, d, e) {
					...
					function g() {
						...
						s(p.$asyncValidators, function(f, g) {
							var l = f(c, d);
							if (!l || !G(l.then)) throw Nb("$asyncValidators", l);
							h(g, t);
